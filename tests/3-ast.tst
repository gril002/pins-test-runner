...
!code:
fun f(x: integer): int = a[10][12][13]
!expected:
Defs [1:1-1:39]
  FunDef [1:1-1:39]: f
    Parameter [1:7-1:17]: x
      Atom [1:10-1:17]: INT
    TypeName [1:20-1:23]: int
    Binary [1:26-1:39]: ARR
      Binary [1:26-1:35]: ARR
        Binary [1:26-1:31]: ARR
          Name [1:26-1:27]: a
          Literal [1:28-1:30]: INT(10)
        Literal [1:32-1:34]: INT(12)
      Literal [1:36-1:38]: INT(13)
!end
...
!code:
fun f(x:integer, y:integer) : integer = x + y + 1
!expected:
Defs [1:1-1:50]
  FunDef [1:1-1:50]: f
    ...
    Parameter [1:18-1:27]: y
      Atom [1:20-1:27]: INT
    Atom [1:31-1:38]: INT
    Binary [1:41-1:50]: ADD
      Binary [1:41-1:46]: ADD
        Name [1:41-1:42]: x
        Name [1:45-1:46]: y
      Literal [1:49-1:50]: INT(1)
!end
...
!expected:
Defs [2:1-8:32]
  FunDef [2:1-8:32]: main
    Parameter [2:12-2:33]: tab
      Array [2:18-2:33]
        [20]
        Atom [2:26-2:33]: INT
    Atom [2:38-2:45]: INT
    Where [2:48-8:32]
      Defs [8:10-8:31]
        VarDef [8:10-8:31]: stSodih
          Atom [8:24-8:31]: INT
      Block [2:48-8:2]
        For [3:5-7:6]
          Name [3:10-3:11]: i
          Literal [3:14-3:15]: INT(0)
          Literal [3:17-3:19]: INT(20)
          Literal [3:21-3:22]: INT(1)
          IfThenElse [4:9-6:10]
            Binary [4:13-4:28]: EQ
              Binary [4:13-4:23]: MOD
                Binary [4:13-4:19]: ARR
                  Name [4:13-4:16]: tab
                  Name [4:17-4:18]: i
                Literal [4:22-4:23]: INT(2)
              Literal [4:27-4:28]: INT(0)
            Binary [5:13-5:36]: ASSIGN
              Name [5:14-5:21]: stSodih
              Binary [5:24-5:35]: ADD
                Name [5:24-5:31]: stSodih
                Literal [5:34-5:35]: INT(1)
!end
...
fun main( x: integer ) : integer = (
    ...
    ) {where var k : integer; var i : integer}
    else (
        {while k < 20:
            (
                {k = k + 1}
      ...
      IfThenElse [2:5-16:6]
        Binary [2:9-2:42]: OR
          Binary [2:9-2:33]: OR
            Binary [2:9-2:24]: AND
              Binary [2:9-2:15]: EQ
                Literal [2:9-2:10]: INT(1)
                Literal [2:14-2:15]: INT(1)
              Binary [2:18-2:24]: EQ
                Literal [2:18-2:19]: INT(2)
                Literal [2:23-2:24]: INT(2)
            Binary [2:27-2:33]: EQ
              Literal [2:27-2:28]: INT(3)
              Literal [2:32-2:33]: INT(3)
          Binary [2:36-2:42]: EQ
            Literal [2:36-2:37]: INT(4)
            Literal [2:41-2:42]: INT(4)
        Where [2:48-8:47]
          Defs [8:14-8:46]
            VarDef [8:14-8:29]: k
              Atom [8:22-8:29]: INT
          ...
          Block [2:48-8:6]
            For [3:9-7:10]
              Name [3:14-3:15]: i
              Literal [3:18-3:19]: INT(0)
              Literal [3:21-3:23]: INT(10)
              Literal [3:25-3:26]: INT(1)
              Where [4:13-6:38]
                Defs [6:22-6:37]
                  VarDef [6:22-6:37]: k
                    Atom [6:30-6:37]: INT
                Block [4:13-6:14]
                  Binary [5:17-5:28]: ASSIGN
                    Name [5:18-5:19]: k
                    Binary [5:22-5:27]: ADD
                      Name [5:22-5:23]: k
                      Name [5:26-5:27]: i
        Block [9:10-15:6]
          While [10:9-14:10]
            Binary [10:16-10:22]: LT
              Name [10:16-10:17]: k
              Literal [10:20-10:22]: INT(20)
            Where [11:13-13:38]
              Defs [13:22-13:37]
                VarDef [13:22-13:37]: k
                  Atom [13:30-13:37]: INT
              Block [11:13-13:14]
                Binary [12:17-12:28]: ASSIGN
                  Name [12:18-12:19]: k
                  Binary [12:22-12:27]: ADD
                    Name [12:22-12:23]: k
                    Literal [12:26-12:27]: INT(1)
      Literal [16:8-16:9]: INT(0)
!end
